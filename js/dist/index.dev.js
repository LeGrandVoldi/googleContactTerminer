...
var tout_les_libelles__main = document.getElementById('tout_les_libelles__main');
...
var bloc__libelle = document.getElementById('bloc__libelle');
setTimeout(function () {
...
var colors = ["#C0392B", "#E74C3C", "#9B59B6", "#8E44AD", "#2980B9", "#3498DB", "#1ABC9C", "#16A085", "#27AE60", "#2ECC71", "#7F8C8D", "#34495E", "#2C3E50"];
var urlImage = "";
...
var mesLibelles = document.getElementById('mesLibelles');
        ...
        if (veriierPoint == 0 || verifierArobase == 0) {
          ...
          if (chainePhone.length < 10) {
            ...
            if (verifierPhone === 1) {
              ...
              bloc_main.hidden = true;
              nombre_de_contact += 1;
              document.getElementById('nombreDeContacts__1').textContent = nombre_de_contact;
              document.getElementById('nombreDeContacts__2').textContent = nombre_de_contact;
...
function messageSuppressionLibelleReussi() {
  var Toast = Swal.mixin({
    toast: true,
    position: "top-end",
    showConfirmButton: false,
  ...
  Toast.fire({
    icon: "success",
    title: "Suppression Libellé réussi avec succès"
  });
}
...
function evenementLibelle() {
  var les__libelles = document.querySelectorAll('.les__libelles');
  ...
  libelles.forEach(function (libelle) {
    libelle.addEventListener('click', function () {
      ...
      var essaieTableau = "";
      var random = 0;
      var nomLibelle = libelle.querySelector('.libelle_2').textContent;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 3:
                ...
                if (url) {
                  for (i = 0; i < Table_libelles_noms.length; i++) {
                    for (y = 0; y < Table_libelles_noms[i].length; y++) {
  ...
  sups.forEach(function (sup) {
    sup.addEventListener('click', function () {
      ...
      swalWithBootstrapButtons.fire({
        ...
        text: "pour la suppression",
        icon: "warning",
        showCancelButton: true,
        confirmButtonText: "Oui, Supprime le!",
        cancelButtonText: "Non, arrête!",
        reverseButtons: true
      }).then(function (result) {
        if (result.isConfirmed) {
          messageSuppressionLibelleReussi();
...
function selectionnerLibelles() {
  bloc__libelle.hidden = false;
  setTimeout(function () {
    bloc__libelle.style.opacity = "1";
  }, 100);
}

function fermerLesLibelle() {
  bloc__libelle.style.opacity = "O";
  setTimeout(function () {
    bloc__libelle.hidden = true;
  }, 100);
  mesLibellesAll();
}

function mesLibellesAll() {
  var tab = "";
  ...
  try {
    for (var _iterator4 = selection_libelle.options[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
  ...
  for (var i = 0; i < Table_libelles_noms_solo.length; i++) {
    tab += "<button class='btn btn-danger'>" + Table_libelles_noms_solo[i] + "</button>   ";
  }

  mesLibelles.innerHTML = tab;
  tab = "";
  Table_libelles_noms_solo = [];
}

function nombreDeLibelles() {
  var calculerLibelle = 0;
  var libelle_2 = document.querySelectorAll('.libelle_2');
  var libelle_4 = document.querySelectorAll('.libelle_4');

  for (var i = 0; i < libelle_2.length; i++) {
    for (var j = 0; j < Table_libelles_noms.length; j++) {
      for (var k = 0; k < Table_libelles_noms[j].length; k++) {
        if (Table_libelles_noms[j][k] == libelle_2[i].textContent) {
          calculerLibelle += 1;
        }
      }
    }

    libelle_4[i].textContent = calculerLibelle;
    calculerLibelle = 0;
  }
}

function toutmescontact() {
  refresh();
  evenementLignesDuTableau();
  refreshLibelle();
  nombreDeLibelles();
