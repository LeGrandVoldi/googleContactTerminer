...
let bloc__libelle = document.getElementById('bloc__libelle');
...
let colors = ["#C0392B","#E74C3C","#9B59B6","#8E44AD","#2980B9","#3498DB","#1ABC9C","#16A085","#27AE60","#2ECC71","#7F8C8D","#34495E","#2C3E50"];
...
let mesLibelles = document.getElementById('mesLibelles');
...
function evenementLibelle(){
    let les__libelles = document.querySelectorAll('.les__libelles')
...
function mesLibellesAll(){
    ...
    for(let i = 0 ; i < Table_libelles_noms_solo.length ; i++){
...
function nombreDeLibelles(){
    let calculerLibelle = 0 ;
    let libelle_2 = document.querySelectorAll('.libelle_2');
    let libelle_4 = document.querySelectorAll('.libelle_4');
    for(let i = 0 ; i < libelle_2.length ; i++){
        
        for(let j = 0 ; j < Table_libelles_noms.length ; j++){
            
            for(let k = 0 ; k < Table_libelles_noms[j].length ; k++){
